...
function showRecommendation(recommendationList){
    const questionContainer = document.getElementById('recommendationQuestionContainer');
...
function addKeyword(){
    ...
    _display_js__WEBPACK_IMPORTED_MODULE_1__.appendKeyword(textInput.value);
    textInput.value = '';
}
...
async function sendKeyword(){
    ...
    if(_ai_js__WEBPACK_IMPORTED_MODULE_2__.getQuestion() === undefined) {
        _display_js__WEBPACK_IMPORTED_MODULE_1__.showRecommendation(await _ai_js__WEBPACK_IMPORTED_MODULE_2__.ask(_query_js__WEBPACK_IMPORTED_MODULE_0__.getKeyList()));
    }
    else{
        _display_js__WEBPACK_IMPORTED_MODULE_1__.showRecommendation(_ai_js__WEBPACK_IMPORTED_MODULE_2__.getQuestion());
    }
}
...
async function refreshQuestion(){
    ...
    _display_js__WEBPACK_IMPORTED_MODULE_1__.showRecommendation(await _ai_js__WEBPACK_IMPORTED_MODULE_2__.refreshQuestion());
}
